$(document).ready(function () {
    $('#modal-gestionar-usuario').on('hidden.bs.modal', function () {
        $("#txtId").val("");
        $("#txtNombre").val("");
        $("#txtApellido").val("");
        $("#txtDNI").val("");
        ...
        "columnDefs": [
            ...
            },
            {
                ...
                "render": function (data, type, full, meta) {
                    return "<center>" +
                        "<button type='button' class='btn btn-primary btn-sm btnEditar' data-toggle='modal' data-target='#modal-gestionar-usuario' data-dismiss='modal'> " +
            ...
            if (resultado.value) {
                $.ajax({
                    ...
                    success: function (respuesta) {
                        ...
                        if (respuesta == '"Error, no se pudo eliminar el usuario') {
                            var ico = 'error';
                        } else {
                            var ico = 'success';
                        }
    ...
    $('#btnGuardar').on('click', function () {
        ...
        if (Nombre.trim() === "" || Apellido.trim() === "" || DNI.trim() === "" || Direccion.trim() === "" || Telefono.trim() === "" || Correo.trim() === "") {
            Toast.fire({
                icon: 'error',
            ...
            swal.fire({
                title: "¡CONFIRMAR!",
                text: "¿Estás seguro que deseas registrar el usuario?",
                icon: "warning",
                showCancelButton: true,
                ...
                if (resultado.value) {
                    $.ajax({
                        ...
                        success: function (respuesta) {
                            ...
                            $("#txtTelefono").val("");
                            $("#txtCorreo").val("");
                            var ico = (respuesta === '"Error, no se pudo registrar el usuario"' || respuesta === '"Error, no se pudo actualizar el usuario"') ? 'error' : 'success';
                            Toast.fire({
                                icon: ico,
                                title: respuesta
                            });
